...
__all__ = ['SingleSegNet', 'MultiSegNet']
...
class MultiSegNet(SingleSegNet):
    ...
    def __init__(
        ...
        super(MultiSegNet, self).__init__(input_channels, None)
    ...
    def forward(self, input_img):
        ...
        # TODO: Refactor with SingleSegNet <31-08-21, Duino> #
        """
        # Encoder
